...
sim_name = "1d_tidal"
exe_dir = '/Users/pattersonjr/modflow/mf6.7.0_macarm/bin/mf6'

workspace = '/Users/pattersonjr/projects/gwf_models/1d_tidal/'
figs_path = os.path.join(workspace, 'figures')
